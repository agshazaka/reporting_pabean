                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 dark:bg-gray-800">
                    <thead class="text-xs text-gray-700 uppercase dark:bg-gray-700 dark:text-gray-400 border-b-2">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3" rowspan="2">Saldo Awal</th>
                            <th scope="col" class="px-4 py-3" rowspan="2">Pemasukan</th>
                            <th scope="col" class="px-4 py-3" rowspan="2">Pengeluaran</th>
                            <th scope="col" class="px-4 py-3" rowspan="2">Penyesuaian</th>
                            <th scope="col" class="px-4 py-3" rowspan="2">Saldo Buku</th>
                            <th scope="col" class="px-4 py-3" rowspan="2">Stock Opname</th>
                            <th scope="col" class="px-4 py-3" rowspan="2">Selisih</th>
                            <th scope="col" class="px-4 py-3" rowspan="2">Keterangan</th>
