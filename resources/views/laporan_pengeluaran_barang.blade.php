                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 dark:bg-gray-800">
                    <thead class="text-xs text-gray-700 uppercase dark:bg-gray-700 dark:text-gray-400 border-b-2">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3" colspan="3">Dokumen Pabean</th>
                            <th scope="col" class="px-4 py-3" colspan="2">Bukti Pengiriman Barang</th>
                            <th scope="col" class="px-4 py-3" rowspan="2">Pengirim Barang</th>
                            ...
                            <th scope="col" class="px-4 py-3" rowspan="2">Nilai</th>
